...
---
title: \"$COLLECTION\"
fastqc_forward_reads: \"$WEB_ADDRESS/data/$TYPE/data/$COLLECTION/fastqc/${COLLECTION}_R1_fastqc.html\"
fastqc_reverse_reads: \"$WEB_ADDRESS/data/$TYPE/data/$COLLECTION/fastqc/${COLLECTION}_R2_fastqc.html\"
...
classification_kraken: \"$WEB_ADDRESS/data/$TYPE/data/$COLLECTION/kraken/$COLLECTION.kraken.html\"
